...
public class ISManager : MonoBehaviour
{
    ...
    public void ExitVipMode()
    {
        isVip = false;
        var powerUps = FindObjectOfType<PowerUps>();
        powerUps.ExitVipState();
    }
    ...
    public void RewardCallBacks()
    {
        ...
        switch (adState)
        {
            ...
            case AdState.ParkingSlot:
                ParkingController.current.rvParkingSpot.UnlockSlot_Callback();
                break;
            ...
            case AdState.CarShuffle:
                ...
                break;
            case AdState.VipSlot:
                isVip=true;
                powerUps.EnterVipState();
                break;
            default:
