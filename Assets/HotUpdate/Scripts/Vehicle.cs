...
namespace TJ.Scripts
{
    public class Vehicle : MonoBehaviour
    {
        ...
        [SerializeField] public List<MeshRenderer> vehMesh;
        ...
        void Start()
        {
            ...
            //UpdateSeatCountNo();
            //UpdatePlayerSeat = SeatCount;
            MakeBoxCollicerWork(true);

            ChangeColor(vehicleColor);
        }



        public void MakeBoxCollicerWork(bool isWork)
        {
            BoxCollider boxCollider = GetComponent<BoxCollider>();
            boxCollider.enabled = isWork;
        }

        // public void ForbiddenRigidbodyWork(bool isKinematic)
        // {
        ...
        private void OnMouseDown()
        {
            ...
            slot = ParkingController.current.FindAvailableSpace();
            if (slot == null)
            {
        ...
        private void MakeColliderVipWork()
        {
            VehicleController.instance.ControlVipState(ISManager.instance.isVip,this);
        }
        ...
        public void VehicleGoing()
        {
            ...
            VehicleController.instance.vehicles = VehicleController.instance.vehicles
                ...
                .ToArray();
            transform.DORotateQuaternion(ParkingController.current.pointOfExit.rotation, 0.2f);
            transform.DOMove(
                    ...
                    slot.enterPoint.transform.position.z), 30f).SetSpeedBased().OnComplete(() =>
            {
                ...
                ParkingController.current.vehiclesInParking.Remove(this);
                transform.parent = null;
                transform.DOMove(ParkingController.current.pointOfExit.transform.position, 35f).SetSpeedBased().SetEase(Ease.InBack)
        ...
        public void MoveCarStraight()
        {
            ...
            SoundController.Instance.PlayOneShot(SoundController.Instance.dragonPop, 0.5f);
                ...
                vehicle.canCollideWitOtherVehicle)
            {
                ...
                if (!isCollided)
                {
                    if (isMovingStraight && counter == 0 && isMovingForward)
                    {
                        ...
                        EffectsManager.instance.PlayEffect(other.ClosestPoint(transform.position + new Vector3(0, 0.25f, 0)), Quaternion.identity);
                    }
        ...
        public void MoveToSlot()
        {
            ...
            transform.DOPath(waypoints, .5f, PathType.CatmullRom).OnWaypointChange(waypointindex =>
                ...
                {
                    isMovingStraight = false;
                    ParkingController.current.vehiclesInParking.Add(this);
                    //slot.isOccupied = true;
                    ...
                    if (ISManager.instance.isVip)
                    {
                        //VehicleController.instance.ControlVipState(false);
                        ISManager.instance.ExitVipMode();
                        MakeColliderVipWork();
                        //VehicleController.instance.ControlVipState(ISManager.instance.isVip,this);
                    }
                });
