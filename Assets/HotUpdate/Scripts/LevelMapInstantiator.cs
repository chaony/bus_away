    ...
    public class LevelMapInstantiator : Singleton<LevelMapInstantiator>
    {
        ...
        void Start()
        {
            ...
            _playButton.onClick.AddListener(() =>
            {
                ...
                {
                    EnergyPanel.instance.ShowEnergyLacking();
                }
                else
                {
        ...
        _playButton.onClick.AddListener(()=>
        {
           ...
           //PlayerPrefs.DeleteAll();
            int testLevel = 2;
            //PlayerPrefs.SetInt(PlayerPrefsManager.LevelProgress, testLevel);
            ...
            if ((level - 1) % 5 == 0 && claimed == 0 && level != 1)
            {
                OpenGiftBox();
            }
        }
        ...
        private void SetLevelImages()
        {
            ...
            for (int i = 0; i < imagesNoToInstantiate; i++)
            {
                ...
                if ((i + startLevel) % 5 == 0 && (i + startLevel) >= level)
                {
