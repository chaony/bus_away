...
const unityNamespace = {
    ...
    bootConfig: 'player-connection-ip=172.16.0.228',
    // 是否以Development Build构建
    isDevelopmentBuild: false,
    // 是否以Profiling Build导出
    isProfilingBuild: false,
    // 预留的堆内存
    unityHeapReservedMemory: 496,
    // 是否向Perfstream上报数据
...
unityNamespace.isCacheableFile = function (path) {
    ...
    const excludeFileIdentifier = ["json", "version"];
